              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 p-4 bg-card rounded-lg shadow-elegant border">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">(31) 98675-2884</p>
                ...
                <div className="flex items-center gap-4 p-4 bg-card rounded-lg shadow-elegant border">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">@jabbudcreations</p>
            ...
            <div className="animate-fade-in">
              <div className="bg-card p-8 rounded-xl shadow-glow border">
                ...
                <div className="mt-8 p-4 bg-muted/50 rounded-lg">
                  <h4 className="font-medium text-foreground mb-2">Por que escolher a Jabbud?</h4>
